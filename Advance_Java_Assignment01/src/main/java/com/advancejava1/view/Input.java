...
public class Input {
	...
	public String getColor(Scanner scn) {
		...
		do {
			...
			//	System.out.println(Color.valueOf(colorType.toUpperCase()));
				...
				System.out.println("Enter a valid color for the Tshirt:\n(available colours are: Black,White,Blue,Purple,Grey,Pink,Maroon,Yellow)");
			}
		}
		while(isValid);
		return colorType;
	...
	public String getSize(Scanner scn) {
		boolean isValid = true;
		System.out.println("Enter size for the Tshirt: \n(choose size: S , M , L, XL )");
		...
		do {
			try {
				...
				System.out.println("Enter a valid size for the Tshirt:\n(choose size: S , M , L, XL )");}
		...
		public String getGender(Scanner scn) {
			...
			public String getOutputPreference(Scanner scn) {
				boolean isValid = true;
				System.out.println("Enter sorting output preference for the Tshirt : \n(Price,Rating,Both)");
